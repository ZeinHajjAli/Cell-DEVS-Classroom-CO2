...
[top]
components : classroom_fewerstudents

[classroom_fewerstudents]
type : cell
...
neighbors :           classroom_fewerstudents(0,-1)
neighbors : classroom_fewerstudents(-1,0)  classroom_fewerstudents(0,0)  classroom_fewerstudents(1,0) 
neighbors :           classroom_fewerstudents(0,1)
...
InitialVariablesValue: classroom_fewerstudents.val
