...
[top]
components : classroom_nobarrier
...
neighbors :           classroom_nobarrier(0,-1)
neighbors : classroom_nobarrier(-1,0)  classroom_nobarrier(0,0)  classroom_nobarrier(1,0) 
neighbors :           classroom_nobarrier(0,1)
...
InitialVariablesValue: classroom_nobarrier.val
