...
neighbors :           classroom_barrier(0,-1)
neighbors : classroom_barrier(-1,0)  classroom_barrier(0,0)  classroom_barrier(1,0) 
neighbors :           classroom_barrier(0,1)
...
InitialVariablesValue: classroom_barrier.val
