...
[top]
components : classroom_staggeredstudents

[classroom_staggeredstudents]
type : cell
...
neighbors :           classroom_staggeredstudents(0,-1)
neighbors : classroom_staggeredstudents(-1,0)  classroom_staggeredstudents(0,0)  classroom_staggeredstudents(1,0) 
neighbors :           classroom_staggeredstudents(0,1)
...
InitialVariablesValue: classroom_staggeredstudents.val
