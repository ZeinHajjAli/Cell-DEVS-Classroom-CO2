...
[top]
components : classroom_smallerbarrier

[classroom_smallerbarrier]
type : cell
...
neighbors :           classroom_smallerbarrier(0,-1)
neighbors : classroom_smallerbarrier(-1,0)  classroom_smallerbarrier(0,0)  classroom_smallerbarrier(1,0) 
neighbors :           classroom_smallerbarrier(0,1)
...
InitialVariablesValue: classroom_smallerbarrier.val
